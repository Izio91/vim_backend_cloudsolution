...
function buildPayloadForSubmitInvoice(jsonInvoice) {
    ...
    let aTo_SuplrInvcItemPurOrdRef = jsonInvoice.PORecords.map((oTo_SuplrInvcItemPurOrdRef, index) => {
        ...
        return {
            ...
            ReferenceDocumentFiscalYear: oTo_SuplrInvcItemPurOrdRef.ReferenceDocumentFiscalYear,
            ReferenceDocumentItem: oTo_SuplrInvcItemPurOrdRef.ReferenceDocumentItem,
    ...
    let aTo_SupplierInvoiceItemGLAcct = jsonInvoice.GLAccountRecords.map((oTo_SupplierInvoiceItemGLAcct, index) => {
        return {
            ...
            TaxCode: oTo_SupplierInvoiceItemGLAcct.TaxCode,
