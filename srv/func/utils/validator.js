    ...
    action_save_submit: Joi.object().min(1).keys({
        ...
        PORecords: Joi.array().items(
            Joi.object().keys({
                ...
                ReferenceDocument: Joi.string().max(10).allow(null),
                ReferenceDocumentFiscalYear: Joi.string().max(4).allow(null),
                ReferenceDocumentItem: Joi.string().max(4).allow(null),
