        ...
        if (oLineDetail.lineDetail_ID) {
            ...
            const poQuery = UPDATE('POIntegrationInfoBody')
                .set({
                    ...
                    "referenceDocument": oLineDetail.ReferenceDocument,
                    "referenceDocumentFiscalYear": oLineDetail.ReferenceDocumentFiscalYear,
                    "referenceDocumentItem": oLineDetail.ReferenceDocumentItem,
