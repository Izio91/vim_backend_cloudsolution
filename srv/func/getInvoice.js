...
function createLineItemForGLAccount(index, oLineDetail, bodyFatturaElettronica, sCompanyCode) {
    return {
        ...
        "IVA": oLineDetail.taxCode ? getIVA(oLineDetail.taxCode) : getIVA(getTaxCode(oLineDetail.aliquotaIVA, oLineDetail.natura)),
        "TaxAmount": oLineDetail.taxCode ? parseFloat(oLineDetail.prezzoTotale) * getIVA(oLineDetail.taxCode) : parseFloat(oLineDetail.prezzoTotale) * getIVA(getTaxCode(oLineDetail.aliquotaIVA, oLineDetail.natura)),
        "GrossAmount": oLineDetail.taxCode ? parseFloat(oLineDetail.prezzoTotale) + (parseFloat(oLineDetail.prezzoTotale) * getIVA(oLineDetail.taxCode)) : parseFloat(oLineDetail.prezzoTotale) + (parseFloat(oLineDetail.prezzoTotale) * getIVA(getTaxCode(oLineDetail.aliquotaIVA, oLineDetail.natura))),
